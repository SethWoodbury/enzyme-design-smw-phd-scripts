...
- `catres_cst_total`: sum of catalytic residue CST scores.
- `catres_cst_mean`: mean per-catalytic-residue CST score.
- `catres_cst_max`: worst per-catalytic-residue CST score.
- `catres_cst_worst_resno`: residue index with worst CST score.
- `catres_cst_worst_value`: CST value at worst residue.
- `catres_cst_n_above_1`: count of catres with CST > 1.0.
- `catres_cst_n_above_2`: count of catres with CST > 2.0.
- `catres_cst_<resno>`: per-residue CST score for each catalytic residue.
