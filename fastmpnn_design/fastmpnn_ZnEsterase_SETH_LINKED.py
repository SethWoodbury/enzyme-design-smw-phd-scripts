...
sys.path.append("/home/woodbuse/special_scripts/fastmpnn_design/FastMPNNDesign")
...
for N_iter in range(args.nstruct):
    ...
    fmd = FastMPNNdesign.FastMPNNdesign(model_type="enhanced_mpnn_V2", params=args.params, scorefxn=sfx, script_file=protocol,
