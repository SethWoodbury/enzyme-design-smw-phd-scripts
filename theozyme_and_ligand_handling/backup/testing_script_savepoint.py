...
def process_files(original_pdb, rotamer_dir, output_dir, atom_pairs, ligands_to_remove_after_pair_fitting):
    ...
    for rotamer_file in os.listdir(rotamer_dir):
        if rotamer_file.endswith(".pdb"):
            ...
            output_pdb = os.path.join(output_dir, f"{rotamer_name}{args.output_suffix}.pdb")
            print('')
...
def main():
    ...
    parser.add_argument('--output_suffix', type=str, required=False, help='String of an output suffix before the ".pdb" extension.')
