...
class PDBDirCyclerLite_tinder(LoadDeleteCycler):
...
def spawnPDBDirCycler_tinder(target_dir='.'):

    viewing.cycler = PDBDirCyclerLite_tinder(target_dir)
...
def setCyclerOnloadCommand_tinder(command_string):
...
cmd.extend( 'tinder', lambda dir='.': spawnPDBDirCycler_tinder('.') )

cmd.extend( 'set_tinder_command', setCyclerOnloadCommand_tinder )
