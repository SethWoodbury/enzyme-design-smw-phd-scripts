...
def main(args):
    ...
    # parser.add_argument("--cart_bonded", action="store_true", default=False, help="(default = False) If enabled, analyzes motif residues for sidechain quality based on Rosetta cart_bonded scoreterm.")
