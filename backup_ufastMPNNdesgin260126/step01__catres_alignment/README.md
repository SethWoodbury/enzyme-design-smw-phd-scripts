...
```bash
/software/containers/universal.sif python /path/to/align_catres.py --input_pdb ... --ref_pdb ... --outdir ...
```
...
```bash
/software/containers/universal.sif /home/woodbuse/special_scripts/upgraded_fastMPNNdesign/modules/step01__catres_alignment/align_catres.py --test
```
...
```bash
# 1. Run alignment
/software/containers/universal.sif python align_catres.py \
