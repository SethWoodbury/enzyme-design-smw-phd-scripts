...
|--------------|-------------|-------------|---------------|----------------|
| Fast protocol | 674s (11m) | 4.3 | 5.2 | 4-6 |
...
- **Affected protocols:** balanced, thorough, and any sweep using these protocols
...
|----------|---------------|--------|
| Balanced protocol | 3 | Need re-run |
| Thorough protocol | 2 | Need re-run |
